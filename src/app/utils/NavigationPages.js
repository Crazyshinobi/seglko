...
function NavigationPages() {
    ...
    return (
        <nav className="text-gray-600 border-b border-[#e1e1e1] text-sm mb-2 h-16 ps-6 justify-center flex flex-row w-full mx-auto">
                    ...
                    return (
                        <li key={to} className="flex items-center">
                            ...
                            {isLast ? (
                                ...
                                <Link href={to} className="hover:text-blue-500">
