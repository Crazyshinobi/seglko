...
export const metadata = {
  ...
  description: "Explore the B.Tech program at Saroj Educational Group (SEG) and discover the specializations, eligibility, career opportunities, and more.",
};
...
const page = () => {
  ...
  <div className="text-center max-w-4xl mx-auto">
    <h1 className="text-5xl font-bold text-blue-900 mb-6 leading-tight">
      Bachelor of Technology <span className="text-blue-600">(B.Tech)</span>
    </h1>
    <p className="text-xl text-gray-700 mb-8">
      Launch your engineering career with our industry-focused undergraduate program designed to shape future technology leaders
    </p>
  ...
  <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
      ...
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Civil Engineering</h3>
          <p className="text-gray-600">
      ...
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Electrical Engineering</h3>
          <p className="text-gray-600">
      ...
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Chemical Engineering</h3>
          <p className="text-gray-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0 bg-blue-700 p-2 rounded-full">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
              </svg>
            </div>
            <div>
    ...
    <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
      <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z" strokeWidth="2" />
        </svg>
      </div>
    ...
    <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
      <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M12 6.253v13M12 6.253C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5s3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" strokeWidth="2" />
        </svg>
      </div>
...
<div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center mt-12">
  ...
  <p className="text-xl mb-8 max-w-2xl mx-auto">
    Join our B.Tech program to become a leader in technology and innovation.
  </p>
  <div className="flex flex-wrap justify-center gap-4">
