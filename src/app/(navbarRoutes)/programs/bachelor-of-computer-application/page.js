...
const page = () => {
  ...
  <div className="text-center max-w-4xl mx-auto">
    <h1 className="text-5xl font-bold text-blue-900 mb-6 leading-tight">
      Bachelor of Computer Applications <span className="text-blue-600">(BCA)</span>
    </h1>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-blue-500">
      ...
      <p className="text-gray-600">Comprehensive 6-semester curriculum with practical focus</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-green-500">
      ...
      <p className="text-gray-600">Cutting-edge technologies with industry relevance</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-purple-500">
      ...
      <p className="text-gray-600">State-of-the-art computer facilities</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-orange-500">
      ...
      <p className="text-gray-600">Strong corporate partnerships for practical experience</p>
    </div>
  </div>
  ...
  <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
    <div className="p-8 md:p-10 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
      ...
      <p className="text-blue-100 max-w-2xl">Develop expertise in key areas of computer applications</p>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Software Development</h3>
          <p className="text-gray-600">Full-stack development, Mobile apps, Agile methodologies</p>
        </div>
      </div>
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          ...
          <p className="text-gray-600">Frontend frameworks, Backend systems, Cloud integration</p>
        </div>
      </div>
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Database Systems</h3>
          <p className="text-gray-600">SQL, NoSQL, Big Data fundamentals</p>
        </div>
      </div>
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Emerging Technologies</h3>
          <p className="text-gray-600">AI basics, IoT, Blockchain fundamentals</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-200">Hands-on projects and real-world case studies</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0 bg-blue-700 p-2 rounded-full">
            ...
            <div>
              <h3 className="text-xl font-semibold">Industry-Aligned Curriculum</h3>
              <p className="text-blue-200">Courses designed with input from IT leaders</p>
            </div>
          </div>
        </div>
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-200">Learn from professors with industry experience</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0 bg-blue-700 p-2 rounded-full">
            ...
            <div>
              ...
              <p className="text-blue-200">Dedicated cell connecting students with IT companies</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center">
    ...
    <p className="text-xl mb-8 max-w-2xl mx-auto">Join our BCA program and become part of the next generation of tech professionals</p>
    <div className="flex flex-wrap justify-center gap-4">
