...
<div className="text-center max-w-4xl mx-auto">
  <h1 className="text-5xl font-bold text-blue-900 mb-6 leading-tight">
    Master of Computer Applications <span className="text-blue-600">(MCA)</span>
  </h1>
  <p className="text-xl text-gray-700 mb-8">
    Advance your tech career with our industry-driven MCA program designed for aspiring IT professionals.
  </p>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-blue-500">
    ...
    <p className="text-gray-600">Advanced curriculum with a focus on industry-relevant technologies.</p>
  </div>
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-green-500">
    ...
    <p className="text-gray-600">Choose from AI, Data Science, Cybersecurity, and more.</p>
  </div>
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-purple-500">
    ...
    <p className="text-gray-600">Real-world projects and case studies to enhance problem-solving.</p>
  </div>
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-orange-500">
    ...
    <p className="text-gray-600">Strong industry connections for internships and career opportunities.</p>
  </div>
</div>
...
<div className="bg-white rounded-2xl shadow-xl overflow-hidden">
  <div className="p-8 md:p-10 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
    ...
    <p className="text-blue-100 max-w-2xl">Master specialized domains in computer applications</p>
  </div>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
    <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
      ...
      <div>
        <h3 className="text-xl font-semibold text-gray-800">Advanced Software Engineering</h3>
        <p className="text-gray-600">Enterprise architecture, DevOps, Cloud-native development</p>
      </div>
    </div>
    <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
      ...
      <div>
        <h3 className="text-xl font-semibold text-gray-800">Data Science & Analytics</h3>
        <p className="text-gray-600">Machine learning, Big Data processing, Predictive modeling</p>
      </div>
    </div>
    <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
      ...
      <div>
        ...
        <p className="text-gray-600">AWS/Azure/GCP, Microservices, Serverless architecture</p>
      </div>
    </div>
    <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
      ...
      <div>
        ...
        <p className="text-gray-600">Ethical hacking, Cryptography, Network security</p>
      </div>
    </div>
  </div>
</div>
...
<div className="bg-blue-900 rounded-2xl text-white overflow-hidden">
  <div className="p-8 md:p-10">
    <h2 className="text-3xl font-bold mb-6">Why Choose Our MCA Program?</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="space-y-6">
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Advanced Technical Training</h3>
            <p className="text-blue-200">Cutting-edge curriculum with industry-standard tools</p>
          </div>
        </div>
        <div className="flex items-start space-x-4">
          <div className="flex-shrink-0 bg-blue-700 p-2 rounded-full">
          ...
          <div>
            ...
            <p className="text-blue-200">Work on innovative projects with faculty guidance</p>
          </div>
        </div>
      </div>
      <div className="space-y-6">
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Industry Collaborations</h3>
            <p className="text-blue-200">Partnerships with leading tech companies</p>
          </div>
        </div>
        <div className="flex items-start space-x-4">
          <div className="flex-shrink-0 bg-blue-700 p-2 rounded-full">
          ...
          <div>
            ...
            <p className="text-blue-200">Prepare for tech leadership and management roles</p>
          </div>
        </div>
      </div>
    </div>
...
<div className="max-w-6xl mx-auto">
  <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Advanced Career Opportunities</h2>
...
<div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center">
  <h2 className="text-3xl font-bold mb-4">Ready to Elevate Your IT Career?</h2>
  <p className="text-xl mb-8 max-w-2xl mx-auto">Join our MCA program and gain the expertise to thrive in the dynamic tech industry.</p>
  <div className="flex flex-wrap justify-center gap-4">
