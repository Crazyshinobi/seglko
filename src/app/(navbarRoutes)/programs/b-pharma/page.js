...
export const metadata = {
    ...
    description : "Explore the B.Pharma program at Saroj Educational Group (SEG) and discover the specializations, eligibility, career opportunities, and more.",
  };
...
const page = () => {
  ...
  <div className="text-center max-w-4xl mx-auto">
    <h1 className="text-5xl font-bold text-blue-900 mb-6 leading-tight">
      Bachelor of Pharmacy <span className="text-blue-600">(B. Pharma)</span>
    </h1>
    <p className="text-xl text-gray-700 mb-8">
      Embark on a journey towards becoming a healthcare professional with our comprehensive B. Pharma program.
    </p>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-blue-500">
      ...
      <p className="text-gray-600">Comprehensive 8-semester curriculum with hands-on training</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-green-500">
      ...
      <p className="text-gray-600">Well-equipped labs for practical exposure and research</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-purple-500">
      ...
      <p className="text-gray-600">Collaborations with leading pharmaceutical companies</p>
    </div>
    <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-orange-500">
      ...
      <p className="text-gray-600">Guidance for placements, higher studies, and entrepreneurship</p>
    </div>
  </div>
  ...
  <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
    <div className="p-8 md:p-10 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
      ...
      <p className="text-blue-100 max-w-2xl">Focus on specialized fields to enhance your expertise.</p>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Pharmaceutical Chemistry</h3>
          <p className="text-gray-600">Drug design, synthesis, and analysis</p>
        </div>
      </div>
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        <div className="bg-green-100 text-green-600 p-3 rounded-full">🧫</div>
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Pharmacology</h3>
          <p className="text-gray-600">Drug action, therapeutic uses, and side effects</p>
        </div>
      </div>
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        <div className="bg-orange-100 text-orange-600 p-3 rounded-full">🧬</div>
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Pharmaceutics</h3>
          <p className="text-gray-600">Formulation, manufacturing, and dispensing</p>
        </div>
      </div>
      <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
        <div className="bg-purple-100 text-purple-600 p-3 rounded-full">🏭</div>
        <div>
          <h3 className="text-xl font-semibold text-gray-800">Pharmaceutical Analysis</h3>
          <p className="text-gray-600">Quality control and assurance techniques</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="p-8 md:p-10">
    <h2 className="text-3xl font-bold mb-6">Why Choose SEG for B. Pharma?</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="space-y-6">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Extensive Practical Exposure</h3>
            <p className="text-blue-200">Gain hands-on experience through advanced pharmaceutical laboratories.</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Industry-Relevant Curriculum</h3>
            <p className="text-blue-200">Stay updated with a curriculum designed by industry experts.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-blue-200">Get guidance from a dedicated placement cell for a successful career.</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Extensive Knowledge Resources</h3>
            <p className="text-blue-200">Access a vast repository of pharmaceutical literature and research materials.</p>
          </div>
        </div>
      </div>
    </div>
...
<div className="max-w-6xl mx-auto mt-12">
  <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Your Future Career Paths</h2>
  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
    {[
      ...
      <div key={title} className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
   ...
   <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center">
    ...
    <p className="text-xl mb-8 max-w-2xl mx-auto">Join our B.Pharma program and become part of the next generation of healthcare leaders, shaping the future of pharmaceutical sciences!</p>
    <div className="flex flex-wrap justify-center gap-4">
      ...
      <button className="border-2 border-white text-white hover:bg-blue-700 px-8 py-3 rounded-full font-bold transition-all">
        Contact Admissions
      </button>
    </div>
  </div>
