            ...
            <div className="space-y-10">
              ...
              <section>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4">
                  <p className="text-blue-800 font-medium">Our Security Commitment</p>
                ...
                <p className="text-gray-700">
                  While we employ robust security measures, no internet transmission
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Situation</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Details</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-800">Service Providers</td>
                        <td className="px-4 py-3 text-sm text-gray-700">Trusted partners who assist in delivering our services</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-800">Legal Requirements</td>
                        <td className="px-4 py-3 text-sm text-gray-700">When required by law or to protect rights and safety</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-800">With Consent</td>
                        <td className="px-4 py-3 text-sm text-gray-700">Only with your explicit permission for specific purposes</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-800 mb-2">What We Use</h3>
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-800 mb-2">Your Control</h3>
                    <p className="text-gray-700 text-sm">
              ...
              <section>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    { title: "Deletion", desc: "Request data erasure where applicable" },
                    { title: "Opt-out", desc: "Unsubscribe from marketing communications" }
                  ].map((right, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
                      <h3 className="font-medium text-blue-600">{right.title}</h3>
              ...
              <section>
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                  <p className="text-yellow-800 font-medium">Notice of Changes</p>
                  <p className="text-yellow-700 mt-1 text-sm">
                    We may update this policy periodically. The "Last updated" date at the top 
                    indicates when revisions were made. We encourage you to review this policy 
                    regularly.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-lg font-medium text-gray-800 mb-3">Saroj Educational Group</h3>
                  <div className="space-y-3">
                    <div className="flex items-start">
                      <svg className="flex-shrink-0 h-5 w-5 text-gray-500 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex items-start">
                      ...
                      <span className="text-gray-700">L-5, First Floor, Lajpat Nagar - II, Delhi, India, 110024</span>
                    </div>
                  </div>
                </div>
              </section>
